...
public class BloomFilterDriver {
	...
	public static void main(String[] args) throws Exception{
		if(args.length < 4) {
			System.err.println("args length must be 4.");
			System.exit(1);
		}
		...
		System.out.println("Training Bloom filter of size " + vectorSize + " with " + nbHash + 
				" hash functions, " + numMembers + " approximate number of records, and " + 
	...
	public static int getOptimalK(int numElements, int vectorSize) {
